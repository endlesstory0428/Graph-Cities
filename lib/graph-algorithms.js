...
class GraphAlgorithms{
	...
	static async getVertexShortestPathInAllFixedPoints(graph, vertex) {
	    if(!graph.graph6 && !graph.graph5 && !graph.graph4 && !graph.graph3 && !graph.graph2) {
            ...
            G.analytics.showSparseNet(graph.graph6, true);
            G.analytics.showSparseNet(graph.graph5, true);
            G.analytics.showSparseNet(graph.graph4, true);
            G.analytics.showSparseNet(graph.graph3, true);
            G.analytics.showSparseNet(graph.graph2, true);
        }
    }
        ...
        if(!G.view.graph.snwormsList) {
            ...
            if (G.view.graph.snwormsList ) {
                ...
                if (G.view.graph.snnumConnections) {
                    G.view.graph.snnumConnections[s] = numConnections;
                } else {
