...
int main(int argc, char *argv[])
{
	...
	uint32_t waveNum = findWaves(degree, startwave, startlevel, mindeg, waveSize, node2label);
	...
	buildWavesAndLabel(outputFile, waves, levels, ccs, startwave, startlevel, waveNum, waveSize, algorithmTime, writeTime, node2label);
