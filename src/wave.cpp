...
void writeToFile(const std::string &prefix, unsigned int *edgeIndices, unsigned int*node2label, unsigned int *waves, unsigned int *levels, unsigned int *ccs, unsigned int *metanodes) {
