...
def draw_mesh_3():
    ...
    scale_factor = peel_value_avg * max_radius / original_height_sum
    ...
    for i in data:
        ...
        for k in (data[i]):
            ...
            start_pos.append(v_count) # height = second key      
            Y_dis = math.log2(int(k)+1)*scale_factor
