...
const Graph=require("./lib/graph.js"),Algs=require("./lib/graph-algorithms.js"),fs = require('node-fs'),zlib = require('zlib'),Buffer = require('buffer').Buffer,path = require('path'),readline=require('readline'),{exec, spawn} = require('child_process');
var datasetFiles={};
var datasets={};
var datasetList;
var datasetIDMaps={};
